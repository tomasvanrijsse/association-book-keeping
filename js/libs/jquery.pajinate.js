...
/*******************************************************************************************/
    ...
    $.fn.pajinate = function(options){
		...
		return this.each(function(){
			...
			$nav_panels.find('.previous_link').next().addClass('active');
		...
		function gotopage(page_num){
			...
			$page_container.find(options.nav_panel_id).children('ul').children('.page_link[longdesc=' + page_num +']').addClass('active')
													 .siblings('.active')
													 .removeClass('active');										 
